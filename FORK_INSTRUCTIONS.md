...
macOS Apple Silicon machine (`Darwin`, `arm64`). Release `novum-v0.2.0` was built
and tested on macOS 26.6.2. It contains both `codex` and `codex-code-mode-host`,
...
- `codex --version` must print `codex-cli 0.2.0 (Novum; commit <full commit>)`.
